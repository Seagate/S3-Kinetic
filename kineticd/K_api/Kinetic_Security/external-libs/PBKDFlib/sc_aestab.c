...
//--------------------------------------------------------------------------
//
// Code to implement functions for AES table loading or generation
//
...
const aes_32t ft_tab[4][256] = 
    { {  sb_data(u0) }, {  sb_data(u1) }, {  sb_data(u2) }, {  sb_data(u3) } };   //lint !e123
#endif
...
const aes_32t fl_tab[4][256] =                                                    
    { {  sb_data(w0) }, {  sb_data(w1) }, {  sb_data(w2) }, {  sb_data(w3) } };   //lint !e123
#endif
...
const aes_32t it_tab[4][256] =                                                    
    { { isb_data(v0) }, { isb_data(v1) }, { isb_data(v2) }, { isb_data(v3) } };   //lint !e123
#endif
...
const aes_32t il_tab[4][256] =                                                    
    { { isb_data(w0) }, { isb_data(w1) }, { isb_data(w2) }, { isb_data(w3) } };   //lint !e123
#endif
...
const aes_32t im_tab[4][256] =                                                    
    { {  mm_data(v0) }, {  mm_data(v1) }, {  mm_data(v2) }, {  mm_data(v3) } };   //lint !e123
#endif
