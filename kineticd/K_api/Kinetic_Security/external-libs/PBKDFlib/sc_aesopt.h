...
#elif 0     /* **** EDIT HERE IF NECESSARY **** */
#define PLATFORM_BYTE_ORDER AES_BIG_ENDIAN
#elif ((0x01020304 >> 24) == 1)
#  define PLATFORM_BYTE_ORDER AES_LITTLE_ENDIAN
#elif ((0x04030201 >> 24) == 1)
#  define PLATFORM_BYTE_ORDER AES_BIG_ENDIAN
...
#if ENC_ROUND == NO_TABLES && ENC_UNROLL != NONE_
#undef  ENC_UNROLL
#define ENC_UNROLL  NONE_
#endif
...
#if DEC_ROUND == NO_TABLES && DEC_UNROLL != NONE_
#undef  DEC_UNROLL
#define DEC_UNROLL  NONE_
#endif
...
#define bval(x,n)       ((aes_08t)((x) >> (8 * (n))))   // Parenthesized the amount by which x has to
                                                        // be shifted as it is a compount expression
...
#define upr(x,n)        ((aes_32t)(x) >> 8 * (n) | (aes_32t)(x) << 32 - 8 * (n))
#define ups(x,n)        ((aes_32t)(x) >> 8 * (n)))
#define bval(x,n)       ((aes_08t)((x) >> (24 - 8 * (n))))   // Parenthesized the amount by which x has to
                                                             // be shifted as it is a compount expression
#define bytes2word(b0, b1, b2, b3)  \
...
#define aes_m1  0x80808080
#define aes_m2  0x7f7f7f7f
#define FFmulX(x)  ((((x) & aes_m2) << 1) ^ ((((x) & aes_m1) >> 7) * BPOLY))

/* The following defines provide alternative definitions of FFmulX that might
   give improved performance if a fast 32-bit multiply is not available. Note
   that a temporary variable u needs to be defined where FFmulX is used.

#define FFmulX(x) (u = (x) & aes_m1, u |= (u >> 1), ((x) & aes_m2) << 1) ^ ((u >> 3) | (u >> 6)) 
#define m4  (0x01010101 * BPOLY)
#define FFmulX(x) (u = (x) & aes_m1, ((x) & aes_m2) << 1) ^ ((u - (u >> 7)) & m4) 
*/
...
#if defined(AES_ENCRYPTION) || defined(AES_ASM)
...
#ifndef _lint // lint considers macros vf1, rf1 and rf2 as variables in macro ls_box(x,c)
#define vf1(x,r,c)  (x)
#define rf1(r,c)    (r)
