...
class NonblockingReceiverInterface {
    ...
    virtual bool Enqueue(shared_ptr<HandlerInterface> handler, google::uint64 sequence,
...
class NonblockingReceiver : public NonblockingReceiverInterface {
    ...
    ~NonblockingReceiver();
    bool Enqueue(shared_ptr<HandlerInterface> handler, google::uint64 sequence,
